...
const indicatorDefinitions = [
  ...
  },
  {
    ...
    releaseNote:
      "Current-constituent proxy refreshed each Saturday. Historical membership changes are not reconstructed; at least 95% constituent coverage is required.",
  ...
  },
  {
    ...
    unit: "Percent",
    releaseNote:
      "Calculated from current S&P 500 constituents and refreshed each Saturday. Historical membership changes are not reconstructed; at least 95% constituent coverage is required.",
