...
const indicatorDefinitions = [
  ...
  },
  {
    ...
    releaseNote: "Nationwide total cash earnings, establishments with five or more employees. The updater reads the total-industry year-over-year figure from the latest official preliminary workbook.",
