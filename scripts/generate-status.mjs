...
const indicatorDefinitions = [
  ...
  },
  {
    ...
    sourceName: "JPX settlement prices; TFX historical daily statistics",
    sourceUrl: "https://www.jpx.co.jp/english/markets/derivatives/settlement-price/index.html",
    sourceUrls: [
      { label: "JPX settlement prices", url: "https://www.jpx.co.jp/english/markets/derivatives/settlement-price/index.html" },
      { label: "TFX historical daily statistics", url: "https://www.tfx.co.jp/en/historical/futures/" },
    ],
    frequency: "Daily, Japan business days",
    unit: "Percent",
    formula: "Map each quarterly 3-Month TONA contract to the nearest BOJ meeting; remove known pre-meeting days; add the dynamic policy/TONA basis; round to the nearest 0.25 percentage-point policy step.",
    releaseNote: "Historical next-meeting levels are backfilled from official TFX daily statistics. The projected line uses current JPX settlements and changes at quarterly BOJ meetings, including September 2026 and December 2026.",
