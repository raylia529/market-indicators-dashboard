...
const indicatorDefinitions = [
  ...
  },
  {
    ...
    sourceUrls: [
      { label: "Yahoo Finance HYG", url: "https://finance.yahoo.com/quote/HYG/history/" },
      { label: "Yahoo Finance IEF", url: "https://finance.yahoo.com/quote/IEF/history/" },
    ],
    frequency: "Daily, US trading days",
    unit: "Adjusted-close ratio",
    formula: "HYG adjusted close / IEF adjusted close on matching trading dates",
    releaseNote:
      "Uses only matching published observations. No forward fill or estimated values are used.",
