...
const sources = [
  ...
  { file: "rsp-spy.csv", columns: { value: "RSP_SPY" } },
  ...
  {
    file: "cme-expected-policy-rate.csv",
    columns: { value: "CME_EXPECTED_POLICY_RATE" },
  },
  ...
  { file: "japan-core-cpi-yoy.csv", columns: { value: "JAPAN_CORE_CPI_YOY" } },
  { file: "tokyo-core-cpi-yoy.csv", columns: { value: "TOKYO_CORE_CPI_YOY" } },
  { file: "us-10-year-treasury-yield.csv", columns: { value: "US_10Y_YIELD" } },
  { file: "us-10y-real-yield.csv", columns: { value: "US_10Y_REAL_YIELD" } },
  {
    file: "us-10y-breakeven-inflation.csv",
    columns: { value: "US_10Y_BREAKEVEN_INFLATION" },
  },
